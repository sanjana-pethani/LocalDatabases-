...
//  LocalDatabases
//
//  Created by sanjana pethani on 08/02/23.
//
...
func getDatabasePath () -> String {
        ...
        let dataBaseFileMainBundlePath = Bundle.main.path(forResource: "employe", ofType: "db")
        print(documentDirectoryPaths)
        print(dataBaseFileMainBundlePath)
        
        let dataPath = documentDirectoryPaths[0] + "/" + "employe.db"
